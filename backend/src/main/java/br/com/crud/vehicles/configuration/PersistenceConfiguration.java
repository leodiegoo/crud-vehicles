package br.com.crud.vehicles.configuration;

import br.com.crud.vehicles.configuration.exception.JOOQToSpringExceptionTransformer;
...
@Configuration
@ComponentScan({
        "br.com.crud.vehicles.repository"
})
@EnableTransactionManagement
@PropertySource("classpath:schema_config.properties")
